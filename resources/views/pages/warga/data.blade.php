...
@section('content')
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="{{ route('home') }}" class="btn btn-success text-white"><i class="far fa-question-circle me-1"></i>
                    + Tambah Pelanggan</a>
            </div>
        </div>
    </div>
                        ...
                        <table id="table-pelanggan" class="table table-centered table-nowrap mb-0 rounded">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0">
                                        <span class="badge bg-secondary">Nama depan</span>
                                    </th>
                                    <th class="border-0">
                                        <span class="badge bg-primary">Nama belakang</span>
                                    </th>
                                    <th class="border-0">
                                        <span class="badge bg-info">TTL</span>
                                    </th>
                                    <th class="border-0">
                                    ...
                                    <th class="border-0">
                                        <span class="badge bg-secondary">No.Telp</span>
                                    </th>
                                    <th class="border-0 rounded-end">
                                        <span class="badge bg-danger">Aksi</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($dataWarga as $item)
                                    <tr>
                                        <td>{{ ($dataWarga->currentPage() - 1) * $dataWarga->perPage() + $loop->iteration }}
                                        </td>
