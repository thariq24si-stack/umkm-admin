...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-black text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <!-- Master Data Section -->
            <li class="nav-item">
                <div class="nav-link d-flex align-items-center text-gray-400 py-2" style="cursor: default;">
                    <span class="sidebar-icon me-3">
                    ...
                    <span class="sidebar-text fw-semibold text-uppercase small">Master Data</span>
                </div>
            </li>

            <li class="nav-item">
                <a href="{{ route('warga.index') }}" class="nav-link d-flex align-items-center py-2 ps-4">
                    <span class="sidebar-icon me-3">
                        <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="nav-item">
                <a href="{{ route('user.index') }}" class="nav-link d-flex align-items-center py-2 ps-4">
                    <span class="sidebar-icon me-3">
                        <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
            ...
            <li class="nav-item">
                <div class="nav-link d-flex align-items-center text-gray-400 py-2" style="cursor: default;">
                    ...
                    <span class="sidebar-text fw-semibold text-uppercase small">Fitur</span>
                </div>
            </li>

            <li class="nav-item">
                <a href="{{ route('produk.index') }}" class="nav-link d-flex align-items-center py-2 ps-4">
                    <span class="sidebar-icon me-3">
                        <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
