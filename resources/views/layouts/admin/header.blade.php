 <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
             ...
             <ul class="navbar-nav align-items-center">
                 ...
                 <li class="nav-item dropdown ms-lg-3">
                     ...
                     <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                         ...
                         <a class="dropdown-item d-flex align-items-center" href="{{ route('developer.profile') }}">
    ...
    Developer Profile
                         ...
                         <form action="{{ route('logout') }}" method="POST" id="logout-form">
                             @csrf
                             <div class="dropdown-item d-flex align-items-cente">
                                 <input type="submit" value="Logout" class="dropdown-item d-flex align-items-center">
